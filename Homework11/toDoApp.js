...
function addHttpRequestDiv(form) {
  let httpRequestDiv = document.createElement('div');
  httpRequestDiv.className = 'request_div';
  httpRequestDiv.style.display = 'inline-block';
...
function addGetRequestButton(httpRequestDiv) {
  let getRequestButton = document.createElement('button');
  getRequestButton.className = 'GET-request_button';
  getRequestButton.style.marginLeft = '10px';
